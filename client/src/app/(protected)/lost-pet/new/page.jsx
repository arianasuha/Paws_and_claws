...
import CreateLostPetModal from "@/components/modals/CreateLostPetModal"
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>Choose your lost pet from the list below</p>
      </div>
      ...
      <CreateLostPetModal isOpen={isModalOpen} onClose={handleModalClose} petId={selectedPetId} />
    </div>
  )
}
