...
export default function OrderDetailPage() {
  ...
  const canCancel = order.order_status !== "cancelled" && order.order_status !== "delivered" && order.user_id == userId
  ...
  return (
    <div className={styles.container}>
      ...
      <OrderDetailCard order={order} isAdmin={userRole === "admin"} adminView={false} />
    </div>
  )
}
